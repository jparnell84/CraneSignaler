        ...
        <div className="min-h-screen bg-slate-800 text-white p-8">
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <Link to="/" className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500">
                            ...
                            {assessments.map(assessment => (
                                <tr key={assessment.id} className="hover:bg-slate-800">
                                    ...
                                    <td className="p-4">
                                        ...
                                        <a href={`#${assessment.id}`} onClick={() => alert(JSON.stringify(assessment.details, null, 2))} className="text-blue-400 hover:underline text-sm">
                                            View Evidence
                                        </a>
                                    </td>
                                </tr>
